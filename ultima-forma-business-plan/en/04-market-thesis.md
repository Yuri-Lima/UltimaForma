...
- Open standards (W3C* Verifiable Credentials, DID*) enable interoperability between systems.
- Cryptography and zero-knowledge proofs enable verification without unnecessary data exposure.
- Cloud infrastructure and standardized APIs* reduce integration cost.
...
To size the market, we use TAM*, SAM* and SOM*.
...
- Grand View Research — [Know Your Customer (KYC) Software Market report (forecast to 2030)](https://grandviewresearch.com/industry-analysis/know-your-customer-software-market-report)
- MarketsandMarkets — [Identity Verification Market (overview)](https://www.marketsandmarkets.com/Market-Reports/identity-verification-market-178660742.html) and public note with 2030 projection in release: [market worth $29.32B by 2030](https://www.prnewswire.com/news-releases/identity-verification-market-worth-29-32-billion-by-2030--exclusive-report-by-marketsandmarkets-302472920.html)
- McKinsey (context on adoption/economic impact of digital ID) — [Digital identification: A key to inclusive growth](https://www.mckinsey.com/capabilities/tech-and-ai/our-insights/digital-identification-a-key-to-inclusive-growth)
